...
class ReadMe(object):
    ...
    def regenerate(self):
        ...
        with open(self.filename, 'a') as f:
            ...
            f.write("|:-|:-|:-|\n")
            f.write("| 规则1：DNS 拦截 | [原始链接](https://raw.githubusercontent.com/YujiaCheng1996/adblockfilters/main/rules/adblockdns.txt) | [加速链接](https://quantil.jsdelivr.net/gh/YujiaCheng1996/adblockfilters@main/rules/adblockdns.txt) |\n")
            f.write("| 规则1'：DNS 拦截 Lite | [原始链接](https://raw.githubusercontent.com/YujiaCheng1996/adblockfilters/main/rules/adblockdnslite.txt) | [加速链接](https://quantil.jsdelivr.net/gh/YujiaCheng1996/adblockfilters@main/rules/adblockdnslite.txt) |\n")
            f.write("| 规则2：插件拦截 | [原始链接](https://raw.githubusercontent.com/YujiaCheng1996/adblockfilters/main/rules/adblockfilters.txt) | [加速链接](https://quantil.jsdelivr.net/gh/YujiaCheng1996/adblockfilters@main/rules/adblockfilters.txt) |\n")
            f.write("| 规则2'：插件拦截 Lite | [原始链接](https://raw.githubusercontent.com/YujiaCheng1996/adblockfilters/main/rules/adblockfilterslite.txt) | [加速链接](https://quantil.jsdelivr.net/gh/YujiaCheng1996/adblockfilters@main/rules/adblockfilterslite.txt) |\n")
            f.write("\n")
            f.write("## 上游规则源\n")
            ...
            for rule in self.ruleList:
                f.write("| %s | %s | [原始链接](%s) | [加速链接](https://quantil.jsdelivr.net/gh/YujiaCheng1996/adblockfilters@main/rules/%s) | %s |\n" % (rule.name,rule.type,rule.url,rule.filename,rule.latest))
            f.write("\n")